...
// Description:
//     Create a COUNTROWS measure for each table selected in the model with the option to create a corresponding 
...
// Make sure at least one table has been selected
if(countSelection == 0)
{
    Error("No tables have been selected");
} 
else
{
    ...
    // Return 1 if user chooses to create calculation group
